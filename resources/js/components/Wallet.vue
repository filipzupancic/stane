<template>
    <div>
        <div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
            ...
            <div class="max-w-md mx-auto sm:max-w-3xl pt-8">
                <div>
                    ...
                    <form class="mt-6 sm:flex sm:items-center" action="#">
                        ...
                        >
                            <input
                                ...
                                placeholder="Ime banke ali mobilne denarnice"
                            />
                            <div
                            ...
                            >
                                ...
                                <select
                                    id="role"
                                    name="role"
                                    class="focus:ring-blue-500 focus:border-blue-500 h-full py-0 pl-4 pr-7 border-transparent bg-transparent text-gray-500 sm:text-sm rounded-md"
                                >
                                    <option>Banke</option>
                ...
                <div class="mt-10">
                    ...
                    >
                        <li v-for="(bank, bankIdx) in banks" :key="bankIdx">
                            <button
                                type="button"
                                class="group p-2 w-full flex items-center justify-between rounded-full border border-gray-300 shadow-sm space-x-3 text-left hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                            >
                                <span
