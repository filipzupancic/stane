...
const steps = [
    ...
    { name: "Step 2", href: "/kredit/drugi-korak", status: "complete" },
    { name: "Step 3", href: "/kredit/tretji-korak", status: "complete" },
    { name: "Step 4", href: "/kredit/cetrti-korak", status: "complete" },
    { name: "Step 5", href: "/kredit/peti-korak", status: "current" },
];
